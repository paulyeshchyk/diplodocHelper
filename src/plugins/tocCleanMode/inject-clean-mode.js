...
(function () {
    ...
    function hideNavigation() {
        ...
        // Расширяем контент
        document.querySelectorAll('.dc-doc-layout__right, .dc-doc-page__main, .dc-doc-page, main').forEach(el => {
            el.style.cssText = `
        ...
        // Хлебные крошки
        document.querySelectorAll('.dc-breadcrumb, [class*="breadcrumb"]').forEach(el => (el.style.display = 'none'));
    }
