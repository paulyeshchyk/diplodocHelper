...
const { defaultTitleValue, defaultHintValue, defaultContextValue, defaultHelptagValue } = require('./config');

/**
 * @param {string} docsDir
 * @returns {import('./types').CollectResult}
 */
function collectHelpData(docsDir) {
    /** @type {import('./types').HelpEntry[]} */
    const success = [];
    /** @type {string[]} */
    const failed = [];
 ...
 * @param {string} docsDir
 * @param {import('./types').HelpEntry[]} success
 * @param {string[]} failed
 */
